<template>
  <div id="app" class="app">
    <b-navbar class="bg-blgnavbar" toggleable="lg" type="dark">
      ...
      <b-navbar-nav>
        <b-nav-item-dropdown text="Pokémon Maps" type="dark">
          ...
          <b-dropdown-item href="/pokemon/unova2">Gen 5 - Unova 2</b-dropdown-item>
          <b-dropdown-divider></b-dropdown-divider>
    ...
    <footer>
      ...
      <div class="container-fluid text-muted">
        <table style="width: 100%; margin-top: 2rem;">
          <tbody>
            <tr>
              <td colspan=2>SimplyBLG's 2020 - 2024</td>
            </tr>
            <tr>
